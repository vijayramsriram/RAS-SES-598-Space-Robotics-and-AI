...
bool cdr_serialize_px4_msgs__msg__Event(
  const px4_msgs__msg__Event * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_px4_msgs__msg__Event(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs__msg__Event * ros_message);
...
bool cdr_serialize_key_px4_msgs__msg__Event(
  const px4_msgs__msg__Event * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_px4_msgs__msg__Event(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_px4_msgs__msg__Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_px4_msgs__msg__ArmingCheckReply(
  const px4_msgs__msg__ArmingCheckReply * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: events
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_px4_msgs__msg__Event(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_deserialize_px4_msgs__msg__ArmingCheckReply(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs__msg__ArmingCheckReply * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  ...
  // Field name: events
  {
    ...
    auto array_ptr = ros_message->events;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_px4_msgs__msg__Event(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_serialize_key_px4_msgs__msg__ArmingCheckReply(
  const px4_msgs__msg__ArmingCheckReply * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
  ...
  // Field name: events
  {
    ...
    auto array_ptr = ros_message->events;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_px4_msgs__msg__Event(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t get_serialized_size_key_px4_msgs__msg__ArmingCheckReply(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArmingCheckReply__ros_msg_type * ros_message = static_cast<const _ArmingCheckReply__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: events
  {
    ...
    auto array_ptr = ros_message->events;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_px4_msgs__msg__Event(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_key_px4_msgs__msg__ArmingCheckReply(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: events
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_px4_msgs__msg__Event(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4_msgs__msg__ArmingCheckReply * ros_message = static_cast<const px4_msgs__msg__ArmingCheckReply *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4_msgs__msg__ArmingCheckReply(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4_msgs__msg__ArmingCheckReply * ros_message = static_cast<px4_msgs__msg__ArmingCheckReply *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4_msgs__msg__ArmingCheckReply(cdr, ros_message);
}
