  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4_msgs__msg__DifferentialDriveSetpoint * ros_message = static_cast<const px4_msgs__msg__DifferentialDriveSetpoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4_msgs__msg__DifferentialDriveSetpoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4_msgs__msg__DifferentialDriveSetpoint * ros_message = static_cast<px4_msgs__msg__DifferentialDriveSetpoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4_msgs__msg__DifferentialDriveSetpoint(cdr, ros_message);
}
