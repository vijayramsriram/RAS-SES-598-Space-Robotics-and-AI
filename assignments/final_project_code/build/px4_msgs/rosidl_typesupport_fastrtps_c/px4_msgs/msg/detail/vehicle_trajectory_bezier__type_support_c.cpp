...
bool cdr_serialize_px4_msgs__msg__TrajectoryBezier(
  const px4_msgs__msg__TrajectoryBezier * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_px4_msgs__msg__TrajectoryBezier(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs__msg__TrajectoryBezier * ros_message);
...
bool cdr_serialize_key_px4_msgs__msg__TrajectoryBezier(
  const px4_msgs__msg__TrajectoryBezier * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_px4_msgs__msg__TrajectoryBezier(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_px4_msgs__msg__TrajectoryBezier(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_px4_msgs__msg__VehicleTrajectoryBezier(
  const px4_msgs__msg__VehicleTrajectoryBezier * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: control_points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_px4_msgs__msg__TrajectoryBezier(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_deserialize_px4_msgs__msg__VehicleTrajectoryBezier(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs__msg__VehicleTrajectoryBezier * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  ...
  // Field name: control_points
  {
    ...
    auto array_ptr = ros_message->control_points;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_px4_msgs__msg__TrajectoryBezier(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_serialize_key_px4_msgs__msg__VehicleTrajectoryBezier(
  const px4_msgs__msg__VehicleTrajectoryBezier * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
  ...
  // Field name: control_points
  {
    ...
    auto array_ptr = ros_message->control_points;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_px4_msgs__msg__TrajectoryBezier(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t get_serialized_size_key_px4_msgs__msg__VehicleTrajectoryBezier(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleTrajectoryBezier__ros_msg_type * ros_message = static_cast<const _VehicleTrajectoryBezier__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: control_points
  {
    ...
    auto array_ptr = ros_message->control_points;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_px4_msgs__msg__TrajectoryBezier(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_key_px4_msgs__msg__VehicleTrajectoryBezier(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: control_points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_px4_msgs__msg__TrajectoryBezier(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4_msgs__msg__VehicleTrajectoryBezier * ros_message = static_cast<const px4_msgs__msg__VehicleTrajectoryBezier *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4_msgs__msg__VehicleTrajectoryBezier(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4_msgs__msg__VehicleTrajectoryBezier * ros_message = static_cast<px4_msgs__msg__VehicleTrajectoryBezier *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4_msgs__msg__VehicleTrajectoryBezier(cdr, ros_message);
}
